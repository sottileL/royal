...
import {getStyledVar} from './vars';

const themeColors = {
    primary: getStyledVar('primary'),
    secondary: getStyledVar('secondary'),
    success: getStyledVar('success'),
    warning: getStyledVar('warning'),
    error: getStyledVar('error'),
    info: getStyledVar('info'),
    black: getStyledVar('black'),
    white: getStyledVar('white'),
    primaryAlt: getStyledVar('primaryAlt'),
    gray: getStyledVar('gray')
};
...
const colors = {
    ...
    shadows: {
        ...
        shadow: '0px 0px 3.40031px rgba(0, 0, 0, 0.2)'
    },
    layout: {
        general: {bodyBg: '#f2f5f9'},
        sidebar: {
    ...
    alpha: {
        ...
        black: {
            ...
            6: alpha(themeColors.black, 0.06),
            8: alpha(themeColors.black, 0.08),
...
export const LightTheme = createTheme({
    ...
    components: {
        ...
        MuiCssBaseline: {
            styleOverrides: {
                ...
                'body.disabled, .disabled, input[readonly], input[disabled]': {
                    backgroundColor: `${colors.gray.lighter} !important`,
                    color: colors.alpha.black[100],
                    '::placeholder': {color: colors.alpha.black[100]}
                },
                'input[readonly]::placeholder': {color: colors.alpha.black[100]},
                '.border-right': {borderRight: '.5px solid rgba(166, 166, 166, 0.44)'},
                '.text-left': {
                    textAlign: 'left',
                ...
                '.form--input-checkbox': {height: '100%'},
                ...
                '.MuiGrid-container': {flex: 1},
                '.uppy-Dashboard-browse': {color: `${colors.primary.main} !important`},
                '.uppy-Dashboard-AddFiles-info': {display: 'none !important'},
                'form .MuiGrid-root.MuiGrid-item': {width: '100%'}
            }
        },
        MuiSelect: {
            styleOverrides: {
        ...
        MuiChip: {
            styleOverrides: {
                colorSecondary: {
                    ...
                    '&:hover': {background: colors.alpha.black[10]}
                },
                deleteIcon: {
        ...
        MuiButton: {
            ...
            styleOverrides: {
                root: {
                    ...
                    '.MuiSvgIcon-root': {transition: 'all .2s'}
                },
        ...
        MuiIconButton: {
            styleOverrides: {
                root: {
                    ...
                    '& .MuiTouchRipple-root': {borderRadius: 8}
                },
                sizeSmall: {padding: 4}
            }
        },
        ...
        MuiDivider: {
            styleOverrides: {
                ...
                vertical: {
                    height: 'auto',
                    width: 1.3,
                    '&.MuiDivider-flexItem.MuiDivider-fullWidth': {height: 'auto'},
                    '&.MuiDivider-absolute.MuiDivider-fullWidth': {height: '100%'}
                },
        ...
        MuiAlert: {
            styleOverrides: {
                ...
                standardInfo: {color: colors.info.main},
                action: {color: colors.alpha.black[70]}
            }
        },
        MuiTimelineDot: {
            styleOverrides: {
        ...
        MuiSwitch: {
            styleOverrides: {
              ...
              'left 150ms cubic-bezier(0.4, 0, 0.2, 1) 0ms,transform 150ms cubic-bezier(0.4, 0, 0.2, 1) 0ms'
                ...
                colorPrimary: {
                    '& .MuiSwitch-thumb': {backgroundColor: colors.alpha.white[100]},

                    '&.Mui-checked .MuiSwitch-thumb': {backgroundColor: colors.primary.main}
                }
            }
        },
        MuiStepper: {
    ...
    typography: {
        fontFamily:
      '"Poppins", Roboto, "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
        h1: {
            fontWeight: 700,
            fontSize: '2em'
        },
